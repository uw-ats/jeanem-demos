/*   Based on script from https://www.w3.org/WAI/ARIA/apg/patterns/radio/examples/radio/
...
class RadioGroup {
  ...
  setChecked(currentItem) {
    // console.log("setChecked: ", currentItem)
    
    for (var i = 0; i < this.radioButtons.length; i++) {
      var rb = this.radioButtons[i];
      rb.setAttribute('aria-checked', 'false');
      rb.tabIndex = -1;
      rb.querySelector('i').classList.replace('bi-record-circle', 'bi-circle')
    }
    currentItem.setAttribute('aria-checked', 'true');
    currentItem.tabIndex = 0;
    currentItem.focus();
    currentItem.querySelector('i').classList.replace('bi-circle', 'bi-record-circle')

  }

  setCheckedToPreviousItem(currentItem) {
    var index;
    // console.log("setCheckedToPreviousItem: ", currentItem)
  ...
  setCheckedToNextItem(currentItem) {
    var index;
    // console.log("setCheckedToNextItem: ", currentItem)
